...
namespace Visual
{
    public partial class vtnMaquinas : Form
    {
        ...
        private void vtnMaquinas_Load(object sender, EventArgs e)
        {
            limpiar();
            generarProductos();
        }
        private void limpiar()
        {
            ...
            miConexion.Open();
            string sql = "SELECT * FROM PRODUCTO INNER JOIN PROVEEDOR ON PRODUCTO.PROVE_NIT = PROVEEDOR.PROVE_NIT WHERE PROD_TIPOPROD = 'maquina'";

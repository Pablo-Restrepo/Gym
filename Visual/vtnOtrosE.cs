...
namespace Visual
{
    public partial class vtnOtrosE : Form
    {
        ...
        private void vtnOtrosE_Load(object sender, EventArgs e)
        {
            limpiar();
            generarProductos();
        }
        private void limpiar()
        {
            ...
            miConexion.Open();
            string sql = "SELECT * FROM EJERCICIO INNER JOIN MAQUINA ON EJERCICIO.MAQ_CODIGO = MAQUINA.MAQ_CODIGO WHERE EJER_TIPOTRENEJER= 'otro'";
